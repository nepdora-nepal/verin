                ...
                <div className="max-w-4xl pt-20">
                    ...
                    >
                        <h1 className="text-5xl md:text-7xl lg:text-8xl  mb-8 leading-[1.1] tracking-tight">
                            Dressed in <span className="text-primary italic">Time</span>, <br />
                            <span className="italic font-light">Not Trends</span>
                        </h1>
                    </motion.div>
                    ...
                    >
                        Crafted with intention and quiet strength — a collection built to move through seasons with poise and permanence. Where every stitch tells a story of timeless elegance.
                    </motion.p>
                    ...
                    >
                        <Link href="/collections">
                            <Button
                                variant="default"
                                size="lg"
                                className=" tracking-[0.2em] text-[10px] font-bold  px-10 py-7 h-auto rounded-full group transition-all duration-300 shadow-xl hover:scale-105 active:scale-95"
                            >
                                Explore Collection
                        ...
                        <Link href="/contact">
                            ...
                            <Button
                                variant="outline"
                                size="lg"
                                className=" tracking-[0.2em] text-[10px] font-bold  px-10 py-7 h-auto rounded-full transition-all duration-300 hover:scale-105"
                            >
                                Contact Us
                            </Button></Link>
                    </motion.div>
